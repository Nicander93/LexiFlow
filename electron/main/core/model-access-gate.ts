...
/** Profiles default to allowing remote providers to keep existing local data compatible. allowRemote 缺省 true，避免旧 Profile 突然拦远程。 */
...
/** Local providers skip consent; remote openai-compatible requires privacy confirmation. 本地免确认，远程必须点过隐私提示。 */
